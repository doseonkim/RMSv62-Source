/*
Made by Dukiz of RZ And [GM]Snappy of MapleMadness (C)
*/
...
function action(mode, type, selection) {
	if (mode == -1) {
		...
		if (status == 0) {
			if(cm.getChar().isGM()
 == true) {
				cm.sendOk("You are a GM! Please !map 180000000 To change your look");
				cm.dispose();
			} else {
				if(cm.getChar().getGender() == 0) {
					cm.sendSimple("Hey there! I could change the way you look! What would you like to change?\r\n#L0#Skin#l\r\n#L1#Hair#l\r\n#L2#Hair Color#l\r\n#L3#Eye#l\r\n#L4#Eye Color#l");
				}else {
					cm.sendOk("What the... OMFG Hacker!! Get lost you Mother F****");
					cm.dispose();
				}
			}
		} else if (status == 1) {
