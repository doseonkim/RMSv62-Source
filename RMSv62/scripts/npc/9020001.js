...
var htright = 8810000;
var duck = 9600002;
var monsterIds = Array(htleft, htright, htleft, duck, htright
			);
...
var prizeIdMount = Array(2384009, 2383001, 2381036, 2382004, 2382048);

var prizeIdEquip = Array(1442023, 1442023);

var prizeIdEtcEquip = Array(1002699, 1002737, 1002728, 1002707, 1002788, 1302091, 1302092, 1302093, 1402049, 1402050, 1402051, 1430248, 1302106, 1472073, 1472074, 1472075);

var prizeIdStar = Array(2070018, 1102041);

var prizeIdChair = Array(3010045, 3010060, 3010064, 3010017, 3010016, 3012005, 3012005, 3010098, 3010085, 3010043, 3010057, 3010046, 3010047);

var prizeIdEtc = Array(4031039, 4001063);						// Diamond and Black Crystal Ores and Screws
var prizeQtyEtc = Array(10, 50);
...
function getPrize(eim,cm) {
  ...
  if (itemSetSel < 0.01)
       ...
       else if (itemSetSel < 0.07)
        itemSet = prizeIdChair;
         else if  (itemSetSel < 0.08 )
        itemSet = prizeIdEtcEquip;
     else if  (itemSetSel < 0.10 )
        itemSet = prizeIdScroll;
    else if (itemSetSel < 0.15)
        itemSet = prizeIdStar;
