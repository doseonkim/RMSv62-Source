var item = Array(1072349, 1002736, 1452060, 1442068, 1382060, 1022060, 1012106, 1432048, 1012076, 1012077, 1012078, 1012079, 1022058, 1302089, 1302088, 1302090, 1302091, 1302092, 1302094, 2041200, 1122001, 1122002, 1122003, 1122004, 1122005, 1122006, 1082246, 1072330, 1072333, 1072334, 1072341, 1062076, 1012084, 1002723, 4080000, 4080001, 4080002, 4080003, 4080004, 4080005, 4080006, 4080007, 4080008, 4080009, 4080010, 4080011, 1022058, 1022060);
var slimenum = 50; // Number of Item needed
var youritem = 4001013;  // Item Needed

function start() {
    var text = "What item do you want, all items are for #r"+slimenum+" #i"+youritem+" \r\n\ \r\n";
