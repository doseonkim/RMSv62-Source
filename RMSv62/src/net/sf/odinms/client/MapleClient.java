...
public class MapleClient {
    ...
    public int login(String login, String pwd, boolean ipMacBanned) {
        ...
        Connection con = DatabaseConnection.getConnection();
        try {
            PreparedStatement ps = con.prepareStatement("SELECT id, password, salt, tempban, banned, gm, macs, lastknownip, votingpoints, greason FROM accounts WHERE name = ?");
