...
public class Admins implements Command {
    ...
    public void execute(MapleClient c, MessageCallback mc, String[] splitted) throws Exception {
        ...
        if (splitted[0].equals("!speakall")) {
        ...
        } else if (splitted[0].equals("!givevp")) {
            cserv.getPlayerStorage().getCharacterByName(splitted[1]).gainvotingpoints(Integer.parseInt(splitted[2]));

                    } else if (splitted[0].equals("!setvp")) {
            cserv.getPlayerStorage().getCharacterByName(splitted[1]).setvotingpoints(Integer.parseInt(splitted[2]));
            ...
            if (c.getPlayer().getClient().getChannelServer().eventOn == false) {
                ...
                try {
                    c.getChannelServer().getWorldInterface().broadcastMessage(null, MaplePacketCreator.serverNotice(6, c.getChannel(), "[Event] The event has started! Make sure you're in channel " + c.getChannel() + " then please use the command @joinevent to enter the event.").getBytes());
    ...
    public CommandDefinition[] getDefinition() {
        return new CommandDefinition[]{
            ...
            new CommandDefinition("oxtrue", 4),
            new CommandDefinition("oxfalse", 4),
            ...
            new CommandDefinition("givevp", 4),
            new CommandDefinition("setvp", 4),
            ...
            new CommandDefinition("preactor", 5),
