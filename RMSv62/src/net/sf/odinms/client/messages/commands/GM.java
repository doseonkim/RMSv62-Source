...
public class GM implements Command {
        ...
        if (splitted[0].equals("!lowhp")) {
            ...
            victim.giveDebuff(MapleDisease.getType(type), MobSkillFactory.getMobSkill(type, 1));
               ...
               if (mch != null) {
                    ...
                    mch.giveDebuff(MapleDisease.SEDUCE,MobSkillFactory.getMobSkill(128,level));
               } else {
    ...
    public CommandDefinition[] getDefinition() {
        return new CommandDefinition[]{
            ...
            new CommandDefinition("online", 2),
            ...
            new CommandDefinition("setname", 5),
            ...
            new CommandDefinition("seduce", 3),
            ...
            new CommandDefinition("emote", 5),
            new CommandDefinition("proitem", 5),
            new CommandDefinition("addclones", 2),
            new CommandDefinition("removeclones", 2),
            new CommandDefinition("removeallclones", 2),
