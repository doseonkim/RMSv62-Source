...
<p><h2>Please Vote For Our Server <33!</h2></p>
    ...
    <div id='text' style='padding: 5px; padding-left: 7px; font-size: 13px;'>
          2) Please use @getpoints1 after you vote to get your voting points!
        </div>
    <div id='text' style='padding: 5px; padding-left: 7px; font-size: 13px;'>
    ...
    <form style='text-align: center; margin-bottom: 2px; margin-top: 5px;' method='post' action='vote2.php'>
        <div style='font-size: 12px; valign:center;'>
            loginID :&nbsp;&nbsp;
            <big><b><strong>
<br><form action="vote2.php" method="POST"><br>
